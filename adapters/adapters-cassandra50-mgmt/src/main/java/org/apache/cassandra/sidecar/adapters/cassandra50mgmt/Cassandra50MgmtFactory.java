...
/**
 * Factory to produce Cassandra 5.x adapter variant with mgmt-api capability.
 */
@Product(AdapterProducts.CASSANDRA_MGMT)
@MinimumVersion("5.0.0")
public class Cassandra50MgmtFactory implements ICassandraFactory
{
    ...
    public Cassandra50MgmtFactory(DnsResolver dnsResolver,
    ...
    {
        return new Cassandra50MgmtAdapter(dnsResolver,
                                          jmxClient,
                                          session,
