...
/**
 * Well-known adapter product identifiers.
 */
public final class AdapterProducts
{
    public static final String CASSANDRA = "cassandra";
    public static final String CASSANDRA_MGMT = "cassandra-mgmt";
    public static final String HCD = "hcd";

    private AdapterProducts()
    {
