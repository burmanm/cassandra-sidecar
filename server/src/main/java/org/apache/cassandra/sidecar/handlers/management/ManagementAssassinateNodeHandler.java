...
/**
 * Handler for management-api compatible assassinate endpoint.
 */
public class ManagementAssassinateNodeHandler extends AbstractHandler<String> implements AccessProtected
{
    @Inject
    public ManagementAssassinateNodeHandler(InstanceMetadataFetcher metadataFetcher,
    ...
    protected String extractParamsOrThrow(RoutingContext context)
    {
        ...
        {
            throw wrapHttpException(HttpResponseStatus.BAD_REQUEST, "Address must be provided");
        }
        return address;
    }
                                  ...
                                  String request)
    {
        executorPools.service()
                     .executeBlocking(() -> {
                         ...
                         operations.assassinate(request);
                         return "OK";
                     })
