...
/**
 * Handler for management-api compatible rebuild endpoint.
 */
public class ManagementRebuildNodeHandler extends AbstractHandler<String> implements AccessProtected
{
    @Inject
    public ManagementRebuildNodeHandler(InstanceMetadataFetcher metadataFetcher,
    ...
    {
        return context.request().getParam("src_dc");
    }
