...
/**
 * Handler for management-api compatible flush endpoint.
 */
public class ManagementFlushTablesHandler extends AbstractHandler<ManagementKeyspaceRequest> implements AccessProtected
{
    @Inject
    public ManagementFlushTablesHandler(InstanceMetadataFetcher metadataFetcher,
