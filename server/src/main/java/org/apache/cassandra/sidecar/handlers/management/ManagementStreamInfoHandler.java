...
/**
 * Handler for management-api compatible stream info endpoint.
 */
public class ManagementStreamInfoHandler extends AbstractHandler<Void> implements AccessProtected
{
    @Inject
    public ManagementStreamInfoHandler(InstanceMetadataFetcher metadataFetcher, ExecutorPools executorPools)
    {
                                  ...
                                  Void request)
    {
        executorPools.service()
                     .executeBlocking(() -> {
                         ...
                         return operations.getStreamInfo();
                     })
