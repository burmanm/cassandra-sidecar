...
/**
 * Handler for management-api compatible drop role endpoint.
 */
public class ManagementDropRoleHandler extends AbstractHandler<String> implements AccessProtected
{
    @Inject
    public ManagementDropRoleHandler(InstanceMetadataFetcher metadataFetcher,
