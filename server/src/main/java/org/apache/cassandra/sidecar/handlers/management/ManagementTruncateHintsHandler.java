...
/**
 * Handler for management-api compatible truncate hints endpoint.
 */
public class ManagementTruncateHintsHandler extends AbstractHandler<String> implements AccessProtected
{
    @Inject
    public ManagementTruncateHintsHandler(InstanceMetadataFetcher metadataFetcher,
    ...
    {
        return context.request().getParam("host");
    }
                                  ...
                                  String request)
    {
        executorPools.service()
                     .executeBlocking(() -> {
                         ...
                         operations.truncateHints(request);
                         return "OK";
                     })
