...
public class ManagementScrubRequest extends ManagementKeyspaceRequest
{
    @JsonProperty("disable_snapshot")
    public boolean disableSnapshot;

    @JsonProperty("skip_corrupted")
    public boolean skipCorrupted;

    @JsonProperty("check_data")
    public boolean checkData;

    @JsonProperty("reinsert_overflowed_ttl")
