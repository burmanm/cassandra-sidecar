...
/**
 * Handler for management-api compatible decommission endpoint.
 */
public class ManagementDecommissionNodeHandler extends AbstractHandler<Boolean> implements AccessProtected
{
    @Inject
    public ManagementDecommissionNodeHandler(InstanceMetadataFetcher metadataFetcher,
