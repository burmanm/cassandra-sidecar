...
/**
 * Handler for management-api compatible clear snapshots endpoint.
 */
public class ManagementClearNodeSnapshotsHandler extends AbstractHandler<ManagementClearNodeSnapshotsHandler.RequestParams>
implements AccessProtected
{
    @Inject
    public ManagementClearNodeSnapshotsHandler(InstanceMetadataFetcher metadataFetcher, ExecutorPools executorPools)
    {
                                  ...
                                  RequestParams request)
    {
        executorPools.service()
                     .executeBlocking(() -> {
                         ...
                         operations.clearSnapshots(request.snapshotNames, request.keyspaces);
                         return "OK";
                     })
